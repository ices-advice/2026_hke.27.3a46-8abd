################################################################################
#  hke.27.3a46-8abd_assessment : short-term forecast GM low summary            #
#------------------------------------------------------------------------------#
...
# model_02c_ForecastGMlowlast_summary.R - STF output summaries (with geometric meanof low last recruitments)
# ~/*_hke.27.3a46-8abd_assessment/model_02c_ForecastGMlowlast_summary.R
...
write.csv(Table_InterR, file.path(dir.tableadv, "table_intermediate_yearGMlowlast_icesRound.csv"), row.names = FALSE)
write.csv(Table_fmult, file.path(dir.tablefore, "table_Fmult.csv"), row.names = FALSE)
# write.csv(Table_fmultR, file.path(tabledir_xxx, "table_Fmult_GMlowlast_icesRound.csv"), row.names = FALSE)
